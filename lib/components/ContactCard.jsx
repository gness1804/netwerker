...
export default class ContactCard extends Component {
  ...
  render() {
    ...
    if (this.state.expanded) {
      ...
      <div>{website ? <a href={website}><div className='companyName'><span className="label">Company: </span> {companyName}</div></a> : <div className='companyName'><span className="label">Company: </span> {companyName}</div>}</div>
